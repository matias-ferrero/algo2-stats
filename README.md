...
- La URL de la planilla a analizar vive en su propia subsección **"Planilla a analizar"**, al principio de `## Constantes`, y está marcada como campo de formulario de Colab (`#@param`): al abrir la notebook en Colab se puede editar desde un cuadro de texto, sin tocar código.
